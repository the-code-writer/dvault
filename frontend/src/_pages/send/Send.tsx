...
import { ITransactionObject, ITransactionStatusEnums } from "../../_components/transactions";
...
const Send: React.FC = () => {
  ...
  const { walletHash, walletAddress, OTCTradesSolanaFunctions }:any = useOTCTradesSolanaData();
  ...
  const executeTransaction = (transactionID:string, payload:ITransactionObject) => {
    setIsLoading(true);
  ...
  const saveTransaction = () => {
    ...
    AxiosAPI.saveTransaction(payload).then(
      (result:any)=>{
        setIsLoading(false);
    ...
    >
      <Content className="txn-main-card" style={{ width: "100%" }}>
        ...
        >
          ...
          <Row>
            <Col span={24}>
              <UnlockCriteria onUnlockCriteriaFormData={onUnlockCriteriaFormDataHandler} />
            </Col>
          </Row>
          ...
          <Row>
            <Col span={24}>
              <RecipientWalletAddress onRecipientWalletAddress={onRecipientWalletAddressHandler} />
            </Col>
          </Row>
          ...
          <Row>
            <Col span={24}>
              <TotalFees onTotalFees={onTotalFeesHandler} amountsInValue={amountsInValue.selectedAmount} />
            </Col>
          </Row>
