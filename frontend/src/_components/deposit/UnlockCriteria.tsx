    ...
    <>
      <Content className="txn-unlock-criteria-wrapper">
          ...
          >
            ...
            <Button type="text" className="txn-unlock-criteria-btn-wrapper">
                    ...
                    <Col xs={24} sm={24} md={12} lg={12} xl={12}>
                      ...
                      >
                        <DatePicker
                          ...
                          className="txn-unlock-criteria-form-input"
                          onChange={(_, f) =>
                            parseDateFromPicker(f, setUnlocksOn)
                          }
                        />
                      </Form.Item>
                    </Col>
                    ...
                    <Col xs={24} sm={24} md={12} lg={12} xl={12}>
                      ...
                      >
                        <DatePicker
                          ...
                          className="txn-unlock-criteria-form-input"
                          onChange={(_, f) =>
                            parseDateFromPicker(f, setExpiresOn)
                          }
                        />
                      </Form.Item>
                    </Col>
                  ...
                  <Row gutter={{ xs: 8, sm: 16, md: 24, lg: 32 }}>
                    <Col xs={24} sm={24} md={24} lg={24} xl={24}>
                      ...
                      >
                        ...
                        />
                        <TokenSelector
                          selectMaxAmount={false}
                          onTokenSelected={onTokenSelectedHandler}
                          size="small"
                          inline
                        />
                      </Form.Item>
